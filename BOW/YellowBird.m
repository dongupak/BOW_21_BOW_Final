...
- (id)init {
	...
	if (self != nil) {
        ...
        //YellowBird의 체력,피해량,점수를 설정합니다.
        HP = 5;
        damage = 30;
        point  = 300;
        
        //5가지 애니메이션을 구성합니다.
        [[CCSpriteFrameCache sharedSpriteFrameCache] addSpriteFramesWithFile:@"yellowbird.plist"];
        NSMutableArray *flyFrames = [NSMutableArray array];
        for(NSInteger idx = 1; idx < 17; idx++) {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:
                                    [NSString stringWithFormat:@"yellow_fly%04d.png",idx]];
		...
		for (NSInteger idx = 1; idx <31; idx++)  {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:
                                    [NSString stringWithFormat:@"yellow_sit%04d.png",idx]];
		...
		for (NSInteger idx = 1; idx <16; idx++)  {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:
                                    [NSString stringWithFormat:@"yellow_tail_%04d.png",idx]];
		...
		for (NSInteger idx = 1; idx <6; idx++)  {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"yellow_flyhit%04d.png",idx]];
        ...
        //노랑새가 총에 맞았을 때(한 번에 죽지않은 경우)보여주는 애니메이션을 정의합니다.
		NSMutableArray *hitFrames = [NSMutableArray array];
		for (NSInteger idx = 1; idx <6; idx++)  {
            CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"yellow_hit%04d.png",idx]];
